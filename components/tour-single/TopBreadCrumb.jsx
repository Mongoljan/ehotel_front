...
const TopBreadCrumb = ({ tourName, location, categoryName = "Tours" }) => {
        ...
        <div className="row y-gap-10 items-center justify-between">
          <div className="col-auto">
            <div className="row x-gap-10 y-gap-5 items-center text-14 text-light-1">
              ...
              {/* End .col-auto */}
              <div className="col-auto">
                <Link href="/tour-list-v1" className="text-light-1 hover:text-blue-1">
          ...
          <div className="col-auto">
            <Link href="/tour-list-v1" className="text-14 text-blue-1 underline">
